<template>
  <div class="page">
    <section class="hero">
      <div class="hero-left">
        <div class="hero-title">优惠券 / 秒杀管理</div>
        <div class="hero-sub">选择店铺后即可查看券池，支持创建普通券与秒杀券（自动预热 Redis 库存）</div>
      </div>
    ...
    <section class="grid-2">
      <div class="card">
        ...
        <div class="section-head">
          <div>
            ...
            <div class="muted">秒杀券包含开始/结束时间与库存</div>
          </div>
        </div>
      ...
      <div class="card">
        <div class="section-head">
          <div>
            <div class="title">创建优惠券</div>
            <div class="muted">创建秒杀券将写入 `tb_seckill_voucher` 并预热 `seckill:{seckill}:stock:&lt;voucherId&gt;`</div>
          </div>
        </div>
