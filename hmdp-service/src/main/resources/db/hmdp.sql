...
CREATE TABLE `tb_blog`  (
  ...
  `content` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '探店的文字描述(HTML)',
...
CREATE TABLE `tb_seckill_voucher`  (
  ...
  `limit_type` tinyint(1) UNSIGNED NOT NULL DEFAULT 1 COMMENT '限购类型：1一人一单 2一人多单 3累计限购',
  `user_limit` int(10) UNSIGNED NOT NULL DEFAULT 1 COMMENT '用户限购阈值（累计限购/或一人一单=1）',
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  ...
  `preheat_status` tinyint(1) UNSIGNED NOT NULL DEFAULT 0 COMMENT '预热状态：0草稿 1预热中 2已预热',
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
...
CREATE TABLE `tb_voucher`  (
  ...
  `limit_type` tinyint(1) UNSIGNED NOT NULL DEFAULT 1 COMMENT '限购类型：1一人一单 2一人多单 3累计限购',
  `user_limit` int(10) UNSIGNED NOT NULL DEFAULT 1 COMMENT '用户限购阈值（累计限购/或一人一单=1）',
  `owner_type` tinyint(1) UNSIGNED NOT NULL DEFAULT 0 COMMENT '券归属：0平台 1商家',
